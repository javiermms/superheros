...
class Ability:
	...
	def attack(self):
		...
		attack_force = random.randint(int(min_attack), self.attack_strength)
...
class Armor:
	...
	def defend(self):
		...
		"""
		defend_strength = random.randint(0, self.defense)
...
# 		self.team_two = Team(team_one_name)
